...
(`rel_aziende_settori_iaf`) e le certificazioni attive (`sys_aziende_certificazioni`
con stato 'ATTIVA'), tramite la tabella di configurazione `cfg_moduli`.
...
centralizzazione della logica di business, doc. cap. 2.3.2).
"""
...
STATO_CERTIFICAZIONE_ATTIVA = "ATTIVA"
    ...
    certificazioni_ids = list(
        db.scalars(
            ...
            .where(
                ...
                CatStatoCertificazione.nome == STATO_CERTIFICAZIONE_ATTIVA,
            )
        )
    )
