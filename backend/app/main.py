...
from app.api.personale_monitoraggio import router as personale_monitoraggio_router
...
from app.api.unita_locali import router as unita_locali_router
...
app.include_router(personale_monitoraggio_router)
