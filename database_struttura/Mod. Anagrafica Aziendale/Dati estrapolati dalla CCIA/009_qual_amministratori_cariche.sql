-- =======================================================
-- QUALIFICHE - AMMINISTRATORI E CARICHE
-- =======================================================

CREATE TABLE IF NOT EXISTS qual_amministratori_cariche (
    ...
    CONSTRAINT fk_qual_amministratori_cariche_azienda
        FOREIGN KEY (azienda_id)
        REFERENCES sys_aziende(id),

    CONSTRAINT fk_qual_amministratori_cariche_persona
        FOREIGN KEY (persona_id)
        REFERENCES per_persone(id),

    CONSTRAINT fk_qual_amministratori_cariche_documento_nomina
        FOREIGN KEY (documento_nomina_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_amministratori_cariche_documento_aggiuntivo
        FOREIGN KEY (documento_aggiuntivo_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_amministratori_cariche_documento_riferimento
        FOREIGN KEY (documento_riferimento_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_amministratori_cariche_documento_qualifica
    ...
    CONSTRAINT chk_qual_amministratori_cariche_scadenza
        CHECK (
    ...
    CONSTRAINT chk_qual_amministratori_cariche_cessazione
        CHECK (
    ...
    CONSTRAINT chk_qual_amministratori_cariche_accettazione
        CHECK (
    ...
    CONSTRAINT uq_qual_amministratori_cariche
        UNIQUE (
            azienda_id,
            persona_id,
            tipo_carica,
