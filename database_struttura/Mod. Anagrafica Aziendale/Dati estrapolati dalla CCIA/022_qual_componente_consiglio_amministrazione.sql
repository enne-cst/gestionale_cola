-- =======================================================
-- QUALIFICHE - COMPONENTE CONSIGLIO DI AMMINISTRAZIONE
-- =======================================================

CREATE TABLE IF NOT EXISTS qual_componente_consiglio_amministrazione (
    ...
    modalita_firma VARCHAR(150),                -- A24 - Modalità di firma

    stato_incarico VARCHAR(100),                -- A25 - Stato dell'incarico

    motivo_cessazione TEXT,                     -- A26 - Motivo della cessazione

    ruolo_nel_consiglio VARCHAR(150) NOT NULL,  -- A28 - Tipologia di incarico
    ...
    -- ===================================================
    -- DATO CAMERALE SPECIFICO
    -- ===================================================

    rappresentante_impresa BOOLEAN,
    ...
    CONSTRAINT fk_qual_componente_cda_azienda
        FOREIGN KEY (azienda_id)
        REFERENCES sys_aziende(id),

    CONSTRAINT fk_qual_componente_cda_persona
        FOREIGN KEY (persona_id)
        REFERENCES per_persone(id),

    CONSTRAINT fk_qual_componente_cda_documento_nomina
        FOREIGN KEY (documento_nomina_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_componente_cda_verbale_elezione
        FOREIGN KEY (verbale_elezione_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_componente_cda_documento_aggiuntivo
        FOREIGN KEY (documento_aggiuntivo_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_componente_cda_documento_riferimento
        FOREIGN KEY (documento_riferimento_id)
        REFERENCES doc_documenti(id),

    CONSTRAINT fk_qual_componente_cda_documento_qualifica
    ...
    CONSTRAINT chk_qual_componente_cda_scadenza
        CHECK (
    ...
    CONSTRAINT chk_qual_componente_cda_cessazione
        CHECK (
    ...
    CONSTRAINT chk_qual_componente_cda_accettazione
        CHECK (
    ...
    CONSTRAINT uq_qual_componente_cda
        UNIQUE (
            azienda_id,
            persona_id,
            ruolo_nel_consiglio,
