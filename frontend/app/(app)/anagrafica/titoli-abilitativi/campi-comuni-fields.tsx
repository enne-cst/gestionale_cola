...
/** I campi comuni alle 4 macro-tipologie (§ Correzione 20 punto 6): numero/
 * attestazione, ente di rilascio, data di rilascio, data di scadenza,
 * "nessuna scadenza", note. Ogni form personalizzato (Albo/Ruolo/Licenza/
 ...
 * possibili. "Documenti collegati" non è ancora rappresentato: il modulo
 * Documenti è oggi solo un placeholder (§ CLAUDE.md), da collegare quando
 * sarà progettato.
 *
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <FormField label="Ente di rilascio" name="ente_rilascio" defaultValue={dati?.ente_rilascio} />
        <FormField label="Data di rilascio" name="data_rilascio" type="date" defaultValue={dati?.data_rilascio} />
